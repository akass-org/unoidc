...
export function Badge({ children, variant = 'default', size = 'sm' }: BadgeProps) {
  const variants = {
    default: 'bg-gray-100 dark:bg-white/[0.06] text-gray-600 dark:text-gray-400 border-gray-200 dark:border-white/[0.08]',
    success: 'bg-emerald-50 dark:bg-emerald-500/[0.08] text-emerald-600 dark:text-emerald-400 border-emerald-200 dark:border-emerald-500/[0.16]',
    warning: 'bg-amber-50 dark:bg-amber-500/[0.08] text-amber-600 dark:text-amber-400 border-amber-200 dark:border-amber-500/[0.16]',
    error: 'bg-red-50 dark:bg-red-500/[0.08] text-red-600 dark:text-red-400 border-red-200 dark:border-red-500/[0.16]',
