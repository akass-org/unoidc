...
import { Shield, Lock, CheckCircle, ArrowLeft, Eye, EyeOff } from "lucide-react";
...
export function ResetPasswordPage() {
    ...
    return (
      <LoginPageWrapper>
        <div className="text-center py-6 page-content">
          ...
          <p className="text-sm text-gray-500 mb-5">重置密码链接无效或已过期，请重新申请。</p>
    ...
    return (
      <LoginPageWrapper>
        <div className="text-center py-6 page-content">
          ...
          <p className="text-sm text-gray-500 mb-5">您的密码已成功重置，请使用新密码登录。</p>
          <Link to="/login">
            <Button size="sm">前往登录</Button>
          </Link>
        </div>
      </LoginPageWrapper>
    );
  ...
  return (
    <LoginPageWrapper>
      ...
      {/* Title */}
      <div className="mb-5">
        <h1 className="text-xl font-bold text-gray-900 dark:text-white mb-0.5">重置密码</h1>
        <p className="text-sm text-gray-500 dark:text-gray-500">请输入您的新密码</p>
      </div>
