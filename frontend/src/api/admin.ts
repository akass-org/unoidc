...
export const adminApi = {
  ...
  createUser: (data: Record<string, unknown>) =>
    api.post("api/v1/admin/users", { json: data }).json(),
  updateUser: (id: string, data: Record<string, unknown>) =>
    api.patch(`api/v1/admin/users/${id}`, { json: data }).json(),
  ...
  createGroup: (data: Record<string, unknown>) =>
    api.post("api/v1/admin/groups", { json: data }).json(),
  updateGroup: (id: string, data: Record<string, unknown>) =>
    api.patch(`api/v1/admin/groups/${id}`, { json: data }).json(),
  ...
  createClient: (data: Record<string, unknown>) =>
    api.post("api/v1/admin/clients", { json: data }).json(),
  updateClient: (id: string, data: Record<string, unknown>) =>
    api.patch(`api/v1/admin/clients/${id}`, { json: data }).json(),
  ...
  updateSettings: (data: Record<string, unknown>) =>
    api.patch("api/v1/admin/settings", { json: data }).json(),
